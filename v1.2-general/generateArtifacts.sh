...
function generateChannelArtifacts() {
	...
	$CONFIGTXGEN -profile ThreeOrgsOrdererGenesis -channelID uniledger-orderer-syschan -outputBlock ./channel-artifacts/genesis.block
